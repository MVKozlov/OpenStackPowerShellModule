    ...
    process
    {
        try
        {
            ...
            foreach($InputObject in $InputObject)
            {
                ...
                Write-OSLogging -Source $MyInvocation.MyCommand.Name -Type INFO -Message "remove Service [$InputObject]"
                
                Invoke-OSApiRequest -HTTPVerb Delete -Type identity -Uri "services/$InputObject" -NoOutput
            }
        }
        catch
        {
